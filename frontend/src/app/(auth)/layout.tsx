      ...
      <div className="relative hidden w-[45%] overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-white">Tributario</span>
          </div>
          <h1 className="mt-16 text-4xl font-bold leading-tight text-white">
            Conoce tus<br />obligaciones<br />tributarias
          </h1>
        ...
        <p className="relative z-10 text-xs text-primary-300">
          Herramienta informativa. No reemplaza asesoría profesional.
        </p>
      </div>
